...
1.  To each well of a Greiner Bio-one 24-well plate (no 662160) apply 50 µl of tap water.
2.  Take a 1.6cm diameter leaf disc from the accession of interest (leaf disk area = 2cm2). 
3.  Depending on the condition prepare:
...
4.  Apply prepared 20ul of a treatment directly onto a leaf disc and let it dry for ~2h at room temperature on a lab bench.
5.  Place the leaf disc in the well with the adaxial side ("upper side of the leaf") upwards. Leaf disc should hardly fit in the well so that it does not move when plate is turned upside down.
6.  Place one larvae per well onto each leaf disc. 
7.  Close the plate with a lid. Seal the sides of the plate with normal adhesive tape. Leave 2 vents on opposite corners of the plate.
8.  Place at room temperature (on a lab bench).
